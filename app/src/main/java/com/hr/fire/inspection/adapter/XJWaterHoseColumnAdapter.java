...
public class XJWaterHoseColumnAdapter  extends RecyclerView.Adapter {
    Context mContext;
    private List<InspectionResult> mData;

    public XJWaterHoseColumnAdapter(Context c, List<InspectionResult> inspectionResults) {
        this.mContext = c;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        XJWaterHoseColumnAdapter.MyViewHolder holder = new XJWaterHoseColumnAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        XJWaterHoseColumnAdapter.MyViewHolder myholder = (XJWaterHoseColumnAdapter.MyViewHolder) holder;
