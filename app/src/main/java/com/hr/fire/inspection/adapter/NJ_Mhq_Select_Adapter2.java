...
public class NJ_Mhq_Select_Adapter2 extends BaseAdapter {
    private List<NJMhqSelectItem2> stringArrayList;
    private final Context mContext;

    public NJ_Mhq_Select_Adapter2(Context rulesActivity, List<NJMhqSelectItem2> workSelectData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.rl_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NJMhqSelectItem2 itemBean = stringArrayList.get(position);
    ...
    //更新工作表中的数据
    public List<NJMhqSelectItem2> getSelection() {
