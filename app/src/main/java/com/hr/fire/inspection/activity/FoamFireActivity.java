    ...
    public void initView() {
        ...
        sys_number_ed.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
                ...
                FoamFireFragment1.its.number = inputText;
                FoamFireFragment2.its.number = inputText;
                FoamFireFragment3.its.number = inputText;
                FoamFireFragment4.its.number = inputText;
            }
