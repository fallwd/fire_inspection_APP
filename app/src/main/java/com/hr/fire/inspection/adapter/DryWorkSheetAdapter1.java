...
public class DryWorkSheetAdapter1 extends BaseAdapter {
    private List<DryPowderFireSysTabSelect1> stringArrayList;
    private final Context mContext;

    public DryWorkSheetAdapter1(Context rulesActivity, List<DryPowderFireSysTabSelect1> workSelectData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.rl_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DryPowderFireSysTabSelect1 itemBean = stringArrayList.get(position);
    ...
    //更新工作表中的数据
    public List<DryPowderFireSysTabSelect1> getSelection() {
