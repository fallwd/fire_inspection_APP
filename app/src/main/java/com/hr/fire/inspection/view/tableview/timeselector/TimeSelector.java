package com.hr.fire.inspection.view.tableview.timeselector;
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        ...
        startCalendar.setTime(TimeUtil.parse(startDate, FORMAT_STR));
        endCalendar.setTime(TimeUtil.parse(endDate, FORMAT_STR));
        initDialog();
        initView();
    }
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String entrust) {
        this.context = context;
        this.handler = resultHandler;
//        initDialog(R.layout.dialog_city);
